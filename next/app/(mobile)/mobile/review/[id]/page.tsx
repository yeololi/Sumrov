      ...
      <div className=" flex flex-col justify-center pt-[121px] border-b border-black border-opacity-25">
        <div className="w-full h-full flex-col justify-start gap-[45px] inline-flex mb-[45px]">
          ...
          <div className="relative w-full h-[44px]">
            <div className="w-full flex flex-wrap i tems-end justify-start gap-[5px]">
              <div className="w-full ml-[10px] text-[14px] font-noto font-semibold text-[#292929] dark:text-white">
                로램잇섬 여우원숭이와 펭귄 황제펭귄
              </div>
              <div className="flex gap-[10px] ml-[10px] ">
                <div className="text-[10px] tracking-[.2em] font-noto font-medium text-[#919191] whitespace-nowrap">
                  Lo****
                </div>
                <div className="text-[10px] tracking-[.1em] font-noto font-medium text-[#919191] whitespace-nowrap">
                  2024-02-11
                </div>
              </div>
        ...
        <div className="relative w-full flex flex-col">
          ...
          <Link
            href={"/mobile/review"}
            className="my-[45px] ml-[5%] w-[40px] h-[23px] flex bg-[#919191] text-[11px] justify-center items-center text-white dark:text-black"
          >
            목록
          </Link>
        </div>
