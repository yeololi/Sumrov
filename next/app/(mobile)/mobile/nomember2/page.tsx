                ...
                <div className="w-[335px] h-full flex-col justify-start items-center gap-[95px] inline-flex">
                    ...
                    <div className="flex flex-col items-start justify-start gap-[22px] mb-[50px]">
                        <div className="flex flex-col items-start justify-start">
                            <div className="text-[13px] font-['Pretendard'] font-medium text-[#000] whitespace-nowrap">
                                주문내역 상세
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col items-start justify-start gap-[18px]">
                            <div className="flex flex-col items-start justify-start gap-[4px]">
                                ...
                                <div className="text-[11px] font-['Pretendard'] text-[#919191] whitespace-nowrap">
                            ...
                            <div className="flex flex-row items-start justify-start gap-[10px]">
                                ...
                                <div className="flex flex-col items-start justify-start gap-[36px]">
                                    <div className="flex flex-col items-start justify-start gap-[4px]">
                                        <div className="text-[11px] font-['Pretendard'] font-medium text-[#000] whitespace-nowrap">
                                            로램잇섬 여우원숭이와 펭귄 황제펭귄
                                        </div>
                                        <div className="flex flex-row items-start justify-start gap-[3px]">
                                            <div className="text-[11px] font-['Pretendard'] font-semibold text-[#000] whitespace-nowrap">
                                                {" "}
                                                KRW 10,000
                                            </div>
                                            <div className="text-[10px] font-['Pretendard'] font-medium text-[#919191] whitespace-nowrap">
                                                -블랙/S 1개
                                            </div>
                                        </div>
                                    </div>
                                    <div className="relative w-[50px] h-[22px] shrink-0">
                                        ...
                                        <div className="absolute left-[7px] top-[5px] text-[10px] font-['Pretendard'] font-medium text-[#508aee] whitespace-nowrap">
                                            배송조회
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="flex flex-col items-start justify-start gap-[17px]">
                            ...
                            <div className="w-full flex flex-row items-start justify-between gap-[204px]">
                                <div className="text-[13px] font-['Pretendard'] text-[#000] whitespace-nowrap">
                                    총 1개 결제금액
                                </div>
                                <div className="text-[13px] font-['Pretendard'] text-[#000] whitespace-nowrap">
                                    13,000원
