              ...
              <div className="self-stretch pr-10 flex-col justify-start items-start gap-20 flex">
                  ...
                  >
                    ...
                    <div className="grow shrink basis-0 flex-col justify-center items-start gap-6 inline-flex">
                      <div className="flex-col justify-center items-start gap-4 flex">
                        <div className="text-lg font-bold font-nav">SUMROV</div>
                        <div className="justify-center items-center gap-2 inline-flex">
                          <div className="p-1 border border-black justify-start items-end flex">
                            <div className="text-center text-xs font-semibold font-pre">
                              {thisData.Status}
                            </div>
                          </div>
                          <div className="text-sm font-normal font-pre">
                        ...
                        <div className="justify-start items-center gap-10 inline-flex">
                          <div className="text-center text-zinc-600 dark:text-neutral-300 text-xs font-normal font-pre">
                            주문수량 : {thisData.amount[i]}pcs
                          </div>
                        </div>
                        <div className="justify-center items-center gap-2 inline-flex">
                          <div className="text-zinc-600 dark:text-neutral-300 text-xs font-normal font-pre">
                ...
                <div className="self-stretch flex-col justify-center items-end gap-10 flex">
                  ...
                  <div className="self-stretch flex-col justify-center items-center gap-4 flex">
                    ...
                    <div className="self-stretch justify-between items-center inline-flex">
                      <div className="text-base font-medium font-pre">
                ...
                <div className="self-stretch flex-col justify-start items-start gap-10 flex">
                  ...
                  <div className="self-stretch flex-col justify-center items-center gap-[21px] flex">
                    ...
                    <div className="self-stretch justify-between items-start inline-flex">
                      <div className="text-sm font-medium font-pre">주소</div>
                      <div className="text-sm font-medium font-pre">
                        {thisData.Addr.split(";").join(" ")}
                      </div>
                    </div>
                    <div className="self-stretch justify-between items-start inline-flex">
                      <div className="text-sm font-medium font-pre">연락처</div>
                      <div className="text-sm font-medium font-pre">
                        {thisData.Phone}
                      </div>
                    </div>
