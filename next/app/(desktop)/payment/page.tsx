        ...
        new window.daum.Postcode({
            oncomplete: function (data: IAddr) {
                (document.getElementById("address") as HTMLInputElement).value =
                    data.address;
                (
                    document.getElementById("zonecode") as HTMLInputElement
                ).value = data.zonecode;
                        ...
                        <div className="pr-[15px] justify-center items-center gap-[305px] flex">
                            <div className="justify-center items-center gap-2.5 flex">
                                <Image
                                    ...
                                    alt="logo"
                                />
                                <div className="text-xl font-semibold font-nav">
                                    SUMROV
                                </div>
                            </div>
                            <Link href={"/"}>
                ...
                <div className="w-[800px] py-[50px] border border-stone-300 flex-col justify-center items-center inline-flex">
                    <div className="flex-col justify-center items-center gap-[50px] flex">
                        ...
                        <div className="h-[276px] flex-col justify-start items-start gap-[50px] flex">
                            <div className="text-lg font-medium font-noto">
                                주문상품 확인
                            </div>
...
>(({ title, className }, ref) => {
    return (
        <div
            className={cn(
                "justify-center items-center gap-0.5 flex",
                className
            )}
        >
